...
class _SignUpState extends State<SignUp> with TickerProviderStateMixin {
        ...
        listener: (BuildContext context, AuthState state) {
          if (state.status == AuthStatus.registered) {
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('User registererd successfully '),
  ...
  Widget _buildAppBar(bool isDark) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: AppSpacing.sm.sp, vertical: 8.h),
      child: Row(
        children: <Widget>[
          IconButton(
            icon: Icon(
    ...
    return ClipRRect(
      ...
      child: BackdropFilter(
        ...
        child: Container(
          decoration: BoxDecoration(
            color: isDark
                ? const Color(0xFF141927).withValues(alpha: 0.95)
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                // Email Input
                _buildLabel('Email Address (Optional)', isDark),
                _buildTextField(
                ...
                SizedBox(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      boxShadow: <BoxShadow>[
                        BoxShadow(
                          color: const Color(0xFF7B2FF7).withValues(alpha: isDark ? 0.45 : 0.3),
                          blurRadius: 24,
                    ...
                    child: ElevatedButton(
                      ...
                      child: state.status == AuthStatus.sendingOtp
                          ? const SizedBox(
                              width: 20,
                              height: 20,
  ...
  Widget _buildTextField({
    ...
    return TextFormField(
      ...
      decoration: InputDecoration(
        filled: true,
        fillColor: inputBg,
        prefixIcon: Icon(icon, color: isDark ? AppColors.textSecondary : AppColors.textSecondaryLight, size: 20),
        ...
        focusedBorder: OutlineInputBorder(
          borderRadius: AppRadius.mdBorder,
          borderSide: const BorderSide(color: Color(0xFF2EFE58), width: 1.5),
        ),
      ),
    );
  }

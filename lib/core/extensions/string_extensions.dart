extension ZetraStringExtension on String {
  ...
  bool get isValidPhone => RegExp(r'^\+?[1-9]\d{7,14}$').hasMatch(trim());

  /// Returns `true` if the string is a valid email address.
  bool get isValidEmail => RegExp(r'^[\w.-]+@[\w.-]+\.[a-zA-Z]{2,}$').hasMatch(trim());
  ...
  bool get isValidZetraQr => startsWith('zetra://charger/');
  ...
  String? get zetraChargerId {
    ...
    const String prefix = 'zetra://charger/';
    ...
    final String id = substring(prefix.length);

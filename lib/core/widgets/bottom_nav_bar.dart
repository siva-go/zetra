...
class _ZetraBottomNavBarState extends State<ZetraBottomNavBar>
  ...
  void didUpdateWidget(covariant ZetraBottomNavBar oldWidget) {
    ...
    if (oldWidget.currentIndex != widget.currentIndex) {
      ...
      if (newIdx >= 0) _riveInputs[newIdx]?.change(true);
      if (oldIdx >= 0) _riveInputs[oldIdx]?.change(false);
    }
  }
                    ...
                    child: Opacity(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(
                            color: qrGreen.withValues(alpha: 0.6),
                            width: 1.5,
                          ),
                        ),
                      ),
                    ...
                    child: Opacity(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(
                            color: qrGlow.withValues(alpha: 0.5),
                          ),
                        ),
                      ),
                    ),
